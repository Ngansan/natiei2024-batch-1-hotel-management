...
public class RentalReceiptsDAOImp extends GenericDAOImp<RentalReceipts, Integer> implements RentalReceiptsDAO{
	...
	/*
	 * // @Override // public void createRentalReceipt(Integer id, String roomName,
	 * LocalDateTime checkInDateTime, LocalDateTime checkOutDateTime, String status)
	 * { // // Sử dụng HQL để lấy thông tin phòng dựa vào tên phòng // String hql =
	 * "FROM Room r WHERE r.name = :roomName"; // Query<Room> query =
	 * getSession().createQuery(hql, Room.class); // query.setParameter("roomName",
	 * roomName); // Room room = query.uniqueResult(); // }
	 */	
